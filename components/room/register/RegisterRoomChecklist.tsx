...
import RegisterRoomSumitFooter from './RegisterRoomSumitFooter';
...
const RegisterRoomChecklist: React.FC = () => {
  ...
  //* 숙소 설명이 채워져 있는지
  const isDescriptiondActived = useMemo(() => {
  ...
  const isTitleActived = useMemo(() => {
    if (!isDescriptiondActived || !title) {
      return false;
    }
    return true;
  }, []);
    ...
    <Container>
      ...
      <ul>
        ...
        <RegisterRoomCheckStep
          ...
          disabled={!isDescriptiondActived}
